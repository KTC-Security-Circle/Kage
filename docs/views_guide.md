...
1. [View レイヤーとは](#view-レイヤーとは)
2. [プロジェクトのディレクトリ構造](#プロジェクトのディレクトリ構造)
3. [ApplicationService 層との連携](#applicationservice-層との連携)
4. [GTD 特化 UI コンポーネント設計](#gtd-特化-ui-コンポーネント設計)
5. [関数ベースのアプローチ](#関数ベースのアプローチ)
6. [クラスベースのアプローチ](#クラスベースのアプローチ)
7. [どちらを選ぶべきか](#どちらを選ぶべきか)
8. [依存性注入と Service Container 使用](#依存性注入と-service-container-使用)
9. [リアルタイム更新とイベント処理](#リアルタイム更新とイベント処理)
10. [実装テンプレート](#実装テンプレート)
11. [ベストプラクティス](#ベストプラクティス)
12. [よくある間違いとその解決策](#よくある間違いとその解決策)
13. [まとめ](#まとめ)
