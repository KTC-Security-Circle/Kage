# Specification: view-components-guidelines
...
See also: views-logic-binding (handler injection), view-state-management (state ownership), base-view-contract (update responsibility)
