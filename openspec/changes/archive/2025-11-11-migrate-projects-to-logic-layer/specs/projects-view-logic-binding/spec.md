# Projects View Logic Binding

## Purpose

Projects 画面を memos と同じアーキテクチャ原則（views-logic-binding）へ準拠させ、ApplicationService 経由のユースケース実行に統一する。UI は変更しない。
...
- Cross-Refs: `views-logic-binding`, `view-state-management`, `views-structure`, `base-view-contract`
